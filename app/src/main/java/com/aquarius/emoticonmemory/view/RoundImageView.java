 ...
 *
 * See on github: https://github.com/gslovemy/RoundImageView
 */
...
//                drawCanvas.restore();
                ...
                // 部分png图片资源是透明的背景，导致显示圆角时有问题， 这里加上白色的底
                canvas.drawRoundRect(new RectF(0, 0, getWidth(), getHeight()), mBorderRadius, mBorderRadius, mBackgroundPaint);
